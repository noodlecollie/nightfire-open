...
{
	return V_strnicmp(s1, s2, INT_MAX);
}
...
int V_snprintf(OUT_Z_CAP(destLen) char* pDest, size_t destLen, PRINTF_FORMAT_STRING const char* pFormat, ...)
	FMTFUNCTION(3, 4);

#define COPY_ALL_CHARACTERS -1
char* V_strncat(
	INOUT_Z_CAP(destBufferSize) char*,
	const char*,
...
void V_SplitString(
	...
	bool bIncludeEmptyStrings = false);
