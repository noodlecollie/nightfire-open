...
public:
	...
	bool TruncateUTF8Bytes(size_t unMaxBytes)
	{
		return TruncateUTF8Internal((size_t)-1, unMaxBytes);
	}
	bool TruncateUTF8Chars(size_t unMaxChars)
	{
		return TruncateUTF8Internal(unMaxChars, (size_t)-1);
	}

private:
	bool TruncateUTF8Internal(size_t unMaxChars, size_t unMaxBytes);
	size_t ReplaceInternal(
...
// Purpose: constructor
//-----------------------------------------------------------------------------
inline CUtlString::CUtlString(const char* pchString) :
	m_pchString(NULL)
{
	SetValue(pchString);
}
...
// Purpose: constructor
//-----------------------------------------------------------------------------
inline CUtlString::CUtlString(CUtlString const& string) :
	m_pchString(NULL)
{
