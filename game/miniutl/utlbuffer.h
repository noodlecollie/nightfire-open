...
#define END_CHAR_CONVERSION(_name, _delimiter, _escapeChar) \
	...
	CUtlCharConversion _name( \
		_escapeChar, \
		_delimiter, \
		sizeof(s_pConversionArray##_name) / sizeof(CUtlCharConversion::ConversionArray_t), \
...
public:
	...
	enum BufferFlags_t
	{
		...
		EXTERNAL_GROWABLE = 0x2,  // This is used w/ external buffers and causes the utlbuf to switch to reallocatable
