...
public:
	...
	cl_entity_s m_VoiceHeadModels[VOICE_MAX_PLAYERS];  // These aren't necessarily in the order of players. They are
													   // just a place for it to put data in during CreateEntities.
