...
static constexpr const char* const FemaleDie[] = {"player/fem_die1.wav"};
...
static constexpr const char* const MaleDie[] = {"player/male_die1.wav", "player/male_die2.wav", "player/male_die3.wav"};
