...
static constexpr const char* const MalePain[] = {
	"player/male_pain1.wav",
	"player/male_pain2.wav",
	"player/male_pain3.wav",
	"player/male_pain4.wav",
	"player/male_pain5.wav",
	"player/male_pain6.wav",
	...
	"player/male_pain14.wav",
	"player/male_pain15.wav",
	"player/male_pain16.wav",
	"player/male_pain17.wav",
	"player/male_pain18.wav",
	"player/male_pain19.wav",
	"player/male_pain20.wav",
};
