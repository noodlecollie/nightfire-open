...
#define bits_SOUND_DANGER \
	(1 << 5)  // pending danger. Grenade that is about to explode, explosive barrel that is damaged, falling crate
...
#define SOUNDLISTTYPE_FREE \
	1  // identifiers passed to functions that can operate on either list, to indicate which list to operate on.
