...
#define bits_COND_ENEMY_DEAD \
	(1 << 20)  // enemy was killed. If you get this in combat, try to find another enemy. If you get it in alert,
			   // victory dance.
...
#define bits_COND_CAN_ATTACK \
	(bits_COND_CAN_RANGE_ATTACK1 | bits_COND_CAN_MELEE_ATTACK1 | bits_COND_CAN_RANGE_ATTACK2 | \
