...
NewKeysOptionsMenu::NewKeysOptionsMenu() :
	NewBaseOptionsMenu("new_keys_options_menu", "keys_options_menu.rml"),
	m_KeyBindings(this),
	m_Modal(this, "keybindings_modal"),
	m_ShowHideEventListener(this, &NewKeysOptionsMenu::ProcessShowHideEvents, {Rml::EventId::Show, Rml::EventId::Hide}),
	m_KeyEventListener(this, &NewKeysOptionsMenu::ProcessKeyEvents, {Rml::EventId::Keydown})
{
...
void NewKeysOptionsMenu::Update(float currentTime)
{
...
bool NewKeysOptionsMenu::OnSetUpDataModelBindings(Rml::DataModelConstructor& constructor)
{
	...
	if ( !constructor.Bind(NAME_SHOW_MODAL, &m_PageModel.showModal) ||
		 ...
		 !constructor.BindEventCallback(EVENT_REBIND_KEY, &NewKeysOptionsMenu::HandleRebindKeyEvent, this) ||
		 !constructor.BindEventCallback(EVENT_SELECT_BINDING, &NewKeysOptionsMenu::HandleSelectBindingEvent, this) ||
		 !constructor.BindEventCallback(EVENT_CLEAR_BINDING, &NewKeysOptionsMenu::HandleClearBinding, this) ||
		 !constructor.BindEventCallback(EVENT_RESET_BINDING, &NewKeysOptionsMenu::HandleResetBindingToDefault, this) ||
		 !constructor.BindEventCallback(
			 EVENT_RESET_ALL_BINDINGS,
			 &NewKeysOptionsMenu::HandleResetAllBindingsToDefaults,
			 this
		 ) )
	{
		return false;
...
void NewKeysOptionsMenu::ProcessShowHideEvents(Rml::Event& event)
{
	switch ( event.GetId() )
	{
...
void NewKeysOptionsMenu::ProcessKeyEvents(Rml::Event& event)
{
...
void NewKeysOptionsMenu::HandleRebindKeyEvent(Rml::DataModelHandle, Rml::Event&, const Rml::VariantList& arguments)
{
	if ( arguments.size() < 2 )
	{
		ASSERT(false);
...
void NewKeysOptionsMenu::HandleSelectBindingEvent(Rml::DataModelHandle, Rml::Event&, const Rml::VariantList& arguments)
{
	if ( arguments.size() < 2 )
	{
		ASSERT(false);
...
void NewKeysOptionsMenu::HandleClearBinding(Rml::DataModelHandle, Rml::Event&, const Rml::VariantList&)
{
...
void NewKeysOptionsMenu::HandleResetBindingToDefault(Rml::DataModelHandle, Rml::Event&, const Rml::VariantList&)
{
	if ( m_PageModel.currentRow < 0 || m_PageModel.currentBinding < 0 )
	{
		return;
...
void NewKeysOptionsMenu::HandleResetAllBindingsToDefaults(Rml::DataModelHandle, Rml::Event&, const Rml::VariantList&)
{
...
void NewKeysOptionsMenu::HandleRebindKeyEvent(int row, int bindIndex)
{
...
bool NewKeysOptionsMenu::HandleSelectBindingEvent(int row, int bindIndex)
{
...
void NewKeysOptionsMenu::ResetRebindingRow()
{
...
void NewKeysOptionsMenu::CloseModalAndStopListeningForKeys()
{
	ShowModal(false);
...
void NewKeysOptionsMenu::ShowModal(bool show)
{
...
void NewKeysOptionsMenu::SetStoredKeyForCurrentRebinding()
{
...
void NewKeysOptionsMenu::ResetAllBindingsResponse(bool shouldReset)
{
	ShowModal(false);
	SetRequestPopOnEscapeKey(true);
