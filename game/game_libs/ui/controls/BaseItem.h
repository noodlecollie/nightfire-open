...
public:
	...
	inline Point GetRenderPosition() const
	{
		return m_scPos;
	}
	inline Size GetRenderSize() const
	{
		return m_scSize;
	}
...
#define GetParent(type) _Parent((type*)(NULL))
	...
	int LastFocusTime() const
	{
		return m_iLastFocusTime;
	}
...
protected:
	...
	virtual bool IsAbsolutePositioned(void) const
	{
		return false;
	}
