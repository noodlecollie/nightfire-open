...
public:
	CMenuGameOptions() :
		CMenuFramework("CMenuGameOptions")
	{
	}
...
void CMenuGameOptions::_Init(void)
{
	...
	AddButton(
		L("Done"),
		L("Save changes and go back to the Customize Menu"),
		PC_DONE,
		VoidCb(&CMenuGameOptions::SaveCb));
