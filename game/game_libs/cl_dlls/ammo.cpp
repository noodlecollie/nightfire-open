...
int CHudAmmo::Init(void)
{
	...
	CL_CvarCreate(
		"hud_fastswitch",
		"0",
		FCVAR_ARCHIVE);  // controls whether or not weapons can be selected in one keypress
...
int CHudAmmo::VidInit(void)
{
	...
	gHR.iHistoryGap =
		Max(gHR.iHistoryGap, gHUD.GetSpriteRect(m_HUD_bucket0).bottom - gHUD.GetSpriteRect(m_HUD_bucket0).top);
