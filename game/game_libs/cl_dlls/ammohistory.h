...
private:
	...
	WEAPON* rgSlots[MAX_WEAPON_SLOTS + 1]
				   [MAX_WEAPON_POSITIONS + 1];  // The slots currently in use by weapons.  The value is a pointer to the
												// weapon;  if it's NULL, no weapon is there
