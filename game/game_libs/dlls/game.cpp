...
// multiplayer server rules
cvar_t teamplay = {"mp_teamplay", "0", FCVAR_SERVER, 0.0f, nullptr};
...
cvar_t weaponstay = {"mp_weaponstay", "0", FCVAR_SERVER, 0.0f, nullptr};
cvar_t selfgauss = {"mp_selfgauss", "1", FCVAR_SERVER, 1.0f, nullptr};
cvar_t satchelfix = {"mp_satchelfix", "0", FCVAR_SERVER, 0.0f, nullptr};
cvar_t forcerespawn = {"mp_forcerespawn", "1", FCVAR_SERVER, 1.0f, nullptr};
cvar_t flashlight = {"mp_flashlight", "0", FCVAR_SERVER, 0.0f, nullptr};
cvar_t aimcrosshair = {"mp_autocrosshair", "1", FCVAR_SERVER, 1.0f, nullptr};
cvar_t decalfrequency = {"decalfrequency", "30", FCVAR_SERVER, 30.0f, nullptr};
cvar_t teamlist = {"mp_teamlist", "hgrunt;scientist", FCVAR_SERVER, 0.0f, nullptr};
cvar_t teamoverride = {"mp_teamoverride", "1", 0, 1.0f, nullptr};
cvar_t defaultteam = {"mp_defaultteam", "0", 0, 0.0f, nullptr};
cvar_t allowmonsters = {"mp_allowmonsters", "0", FCVAR_SERVER, 0.0f, nullptr};
cvar_t bhopcap = {"mp_bhopcap", "1", FCVAR_SERVER, 1.0f, nullptr};

// Avoid respawning players closer to where they last died than this.
cvar_t mp_respawn_avoid_radius = {"mp_respawn_avoid_radius", "192", FCVAR_SERVER, 192.0f, nullptr};
cvar_t mp_corpse_show_time = {"mp_corpse_show_time", "30", FCVAR_SERVER, 30.0f, nullptr};

cvar_t allow_spectators =
	{"allow_spectators", "1", FCVAR_SERVER, 1.0f, nullptr};  // 0 prevents players from being spectators
cvar_t multibyte_only = {"mp_multibyte_only", "0", FCVAR_SERVER, 0.0f, nullptr};

cvar_t mp_chattime = {"mp_chattime", "10", FCVAR_SERVER, 10.0f, nullptr};
...
//  Agrunt
cvar_t sk_agrunt_health1 = {"sk_agrunt_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_agrunt_health2 = {"sk_agrunt_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_agrunt_health3 = {"sk_agrunt_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_agrunt_dmg_punch1 = {"sk_agrunt_dmg_punch1", "0", 0, 0.0f, nullptr};
cvar_t sk_agrunt_dmg_punch2 = {"sk_agrunt_dmg_punch2", "0", 0, 0.0f, nullptr};
cvar_t sk_agrunt_dmg_punch3 = {"sk_agrunt_dmg_punch3", "0", 0, 0.0f, nullptr};

// Apache
cvar_t sk_apache_health1 = {"sk_apache_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_apache_health2 = {"sk_apache_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_apache_health3 = {"sk_apache_health3", "0", 0, 0.0f, nullptr};

// Barney
cvar_t sk_barney_health1 = {"sk_barney_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_barney_health2 = {"sk_barney_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_barney_health3 = {"sk_barney_health3", "0", 0, 0.0f, nullptr};

// Bullsquid
cvar_t sk_bullsquid_health1 = {"sk_bullsquid_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_bullsquid_health2 = {"sk_bullsquid_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_bullsquid_health3 = {"sk_bullsquid_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_bullsquid_dmg_bite1 = {"sk_bullsquid_dmg_bite1", "0", 0, 0.0f, nullptr};
cvar_t sk_bullsquid_dmg_bite2 = {"sk_bullsquid_dmg_bite2", "0", 0, 0.0f, nullptr};
cvar_t sk_bullsquid_dmg_bite3 = {"sk_bullsquid_dmg_bite3", "0", 0, 0.0f, nullptr};

cvar_t sk_bullsquid_dmg_whip1 = {"sk_bullsquid_dmg_whip1", "0", 0, 0.0f, nullptr};
cvar_t sk_bullsquid_dmg_whip2 = {"sk_bullsquid_dmg_whip2", "0", 0, 0.0f, nullptr};
cvar_t sk_bullsquid_dmg_whip3 = {"sk_bullsquid_dmg_whip3", "0", 0, 0.0f, nullptr};

cvar_t sk_bullsquid_dmg_spit1 = {"sk_bullsquid_dmg_spit1", "0", 0, 0.0f, nullptr};
cvar_t sk_bullsquid_dmg_spit2 = {"sk_bullsquid_dmg_spit2", "0", 0, 0.0f, nullptr};
cvar_t sk_bullsquid_dmg_spit3 = {"sk_bullsquid_dmg_spit3", "0", 0, 0.0f, nullptr};

// Big Momma
cvar_t sk_bigmomma_health_factor1 = {"sk_bigmomma_health_factor1", "1.0", 0, 1.0f, nullptr};
cvar_t sk_bigmomma_health_factor2 = {"sk_bigmomma_health_factor2", "1.0", 0, 1.0f, nullptr};
cvar_t sk_bigmomma_health_factor3 = {"sk_bigmomma_health_factor3", "1.0", 0, 1.0f, nullptr};

cvar_t sk_bigmomma_dmg_slash1 = {"sk_bigmomma_dmg_slash1", "50", 0, 50.0f, nullptr};
cvar_t sk_bigmomma_dmg_slash2 = {"sk_bigmomma_dmg_slash2", "50", 0, 50.0f, nullptr};
cvar_t sk_bigmomma_dmg_slash3 = {"sk_bigmomma_dmg_slash3", "50", 0, 50.0f, nullptr};

cvar_t sk_bigmomma_dmg_blast1 = {"sk_bigmomma_dmg_blast1", "100", 0, 100.0f, nullptr};
cvar_t sk_bigmomma_dmg_blast2 = {"sk_bigmomma_dmg_blast2", "100", 0, 100.0f, nullptr};
cvar_t sk_bigmomma_dmg_blast3 = {"sk_bigmomma_dmg_blast3", "100", 0, 100.0f, nullptr};

cvar_t sk_bigmomma_radius_blast1 = {"sk_bigmomma_radius_blast1", "250", 0, 250.0f, nullptr};
cvar_t sk_bigmomma_radius_blast2 = {"sk_bigmomma_radius_blast2", "250", 0, 250.0f, nullptr};
cvar_t sk_bigmomma_radius_blast3 = {"sk_bigmomma_radius_blast3", "250", 0, 250.0f, nullptr};

// Gargantua
cvar_t sk_gargantua_health1 = {"sk_gargantua_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_gargantua_health2 = {"sk_gargantua_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_gargantua_health3 = {"sk_gargantua_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_gargantua_dmg_slash1 = {"sk_gargantua_dmg_slash1", "0", 0, 0.0f, nullptr};
cvar_t sk_gargantua_dmg_slash2 = {"sk_gargantua_dmg_slash2", "0", 0, 0.0f, nullptr};
cvar_t sk_gargantua_dmg_slash3 = {"sk_gargantua_dmg_slash3", "0", 0, 0.0f, nullptr};

cvar_t sk_gargantua_dmg_fire1 = {"sk_gargantua_dmg_fire1", "0", 0, 0.0f, nullptr};
cvar_t sk_gargantua_dmg_fire2 = {"sk_gargantua_dmg_fire2", "0", 0, 0.0f, nullptr};
cvar_t sk_gargantua_dmg_fire3 = {"sk_gargantua_dmg_fire3", "0", 0, 0.0f, nullptr};

cvar_t sk_gargantua_dmg_stomp1 = {"sk_gargantua_dmg_stomp1", "0", 0, 0.0f, nullptr};
cvar_t sk_gargantua_dmg_stomp2 = {"sk_gargantua_dmg_stomp2", "0", 0, 0.0f, nullptr};
cvar_t sk_gargantua_dmg_stomp3 = {"sk_gargantua_dmg_stomp3", "0", 0, 0.0f, nullptr};

// Hassassin
cvar_t sk_hassassin_health1 = {"sk_hassassin_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_hassassin_health2 = {"sk_hassassin_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_hassassin_health3 = {"sk_hassassin_health3", "0", 0, 0.0f, nullptr};

// Headcrab
cvar_t sk_headcrab_health1 = {"sk_headcrab_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_headcrab_health2 = {"sk_headcrab_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_headcrab_health3 = {"sk_headcrab_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_headcrab_dmg_bite1 = {"sk_headcrab_dmg_bite1", "0", 0, 0.0f, nullptr};
cvar_t sk_headcrab_dmg_bite2 = {"sk_headcrab_dmg_bite2", "0", 0, 0.0f, nullptr};
cvar_t sk_headcrab_dmg_bite3 = {"sk_headcrab_dmg_bite3", "0", 0, 0.0f, nullptr};

// Hgrunt
cvar_t sk_hgrunt_health1 = {"sk_hgrunt_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_hgrunt_health2 = {"sk_hgrunt_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_hgrunt_health3 = {"sk_hgrunt_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_hgrunt_kick1 = {"sk_hgrunt_kick1", "0", 0, 0.0f, nullptr};
cvar_t sk_hgrunt_kick2 = {"sk_hgrunt_kick2", "0", 0, 0.0f, nullptr};
cvar_t sk_hgrunt_kick3 = {"sk_hgrunt_kick3", "0", 0, 0.0f, nullptr};

cvar_t sk_hgrunt_pellets1 = {"sk_hgrunt_pellets1", "0", 0, 0.0f, nullptr};
cvar_t sk_hgrunt_pellets2 = {"sk_hgrunt_pellets2", "0", 0, 0.0f, nullptr};
cvar_t sk_hgrunt_pellets3 = {"sk_hgrunt_pellets3", "0", 0, 0.0f, nullptr};

cvar_t sk_hgrunt_gspeed1 = {"sk_hgrunt_gspeed1", "0", 0, 0.0f, nullptr};
cvar_t sk_hgrunt_gspeed2 = {"sk_hgrunt_gspeed2", "0", 0, 0.0f, nullptr};
cvar_t sk_hgrunt_gspeed3 = {"sk_hgrunt_gspeed3", "0", 0, 0.0f, nullptr};

// Houndeye
cvar_t sk_houndeye_health1 = {"sk_houndeye_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_houndeye_health2 = {"sk_houndeye_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_houndeye_health3 = {"sk_houndeye_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_houndeye_dmg_blast1 = {"sk_houndeye_dmg_blast1", "0", 0, 0.0f, nullptr};
cvar_t sk_houndeye_dmg_blast2 = {"sk_houndeye_dmg_blast2", "0", 0, 0.0f, nullptr};
cvar_t sk_houndeye_dmg_blast3 = {"sk_houndeye_dmg_blast3", "0", 0, 0.0f, nullptr};

// ISlave
cvar_t sk_islave_health1 = {"sk_islave_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_islave_health2 = {"sk_islave_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_islave_health3 = {"sk_islave_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_islave_dmg_claw1 = {"sk_islave_dmg_claw1", "0", 0, 0.0f, nullptr};
cvar_t sk_islave_dmg_claw2 = {"sk_islave_dmg_claw2", "0", 0, 0.0f, nullptr};
cvar_t sk_islave_dmg_claw3 = {"sk_islave_dmg_claw3", "0", 0, 0.0f, nullptr};

cvar_t sk_islave_dmg_clawrake1 = {"sk_islave_dmg_clawrake1", "0", 0, 0.0f, nullptr};
cvar_t sk_islave_dmg_clawrake2 = {"sk_islave_dmg_clawrake2", "0", 0, 0.0f, nullptr};
cvar_t sk_islave_dmg_clawrake3 = {"sk_islave_dmg_clawrake3", "0", 0, 0.0f, nullptr};

cvar_t sk_islave_dmg_zap1 = {"sk_islave_dmg_zap1", "0", 0, 0.0f, nullptr};
cvar_t sk_islave_dmg_zap2 = {"sk_islave_dmg_zap2", "0", 0, 0.0f, nullptr};
cvar_t sk_islave_dmg_zap3 = {"sk_islave_dmg_zap3", "0", 0, 0.0f, nullptr};

// Icthyosaur
cvar_t sk_ichthyosaur_health1 = {"sk_ichthyosaur_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_ichthyosaur_health2 = {"sk_ichthyosaur_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_ichthyosaur_health3 = {"sk_ichthyosaur_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_ichthyosaur_shake1 = {"sk_ichthyosaur_shake1", "0", 0, 0.0f, nullptr};
cvar_t sk_ichthyosaur_shake2 = {"sk_ichthyosaur_shake2", "0", 0, 0.0f, nullptr};
cvar_t sk_ichthyosaur_shake3 = {"sk_ichthyosaur_shake3", "0", 0, 0.0f, nullptr};

// Leech
cvar_t sk_leech_health1 = {"sk_leech_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_leech_health2 = {"sk_leech_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_leech_health3 = {"sk_leech_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_leech_dmg_bite1 = {"sk_leech_dmg_bite1", "0", 0, 0.0f, nullptr};
cvar_t sk_leech_dmg_bite2 = {"sk_leech_dmg_bite2", "0", 0, 0.0f, nullptr};
cvar_t sk_leech_dmg_bite3 = {"sk_leech_dmg_bite3", "0", 0, 0.0f, nullptr};

// Controller
cvar_t sk_controller_health1 = {"sk_controller_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_controller_health2 = {"sk_controller_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_controller_health3 = {"sk_controller_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_controller_dmgzap1 = {"sk_controller_dmgzap1", "0", 0, 0.0f, nullptr};
cvar_t sk_controller_dmgzap2 = {"sk_controller_dmgzap2", "0", 0, 0.0f, nullptr};
cvar_t sk_controller_dmgzap3 = {"sk_controller_dmgzap3", "0", 0, 0.0f, nullptr};

cvar_t sk_controller_speedball1 = {"sk_controller_speedball1", "0", 0, 0.0f, nullptr};
cvar_t sk_controller_speedball2 = {"sk_controller_speedball2", "0", 0, 0.0f, nullptr};
cvar_t sk_controller_speedball3 = {"sk_controller_speedball3", "0", 0, 0.0f, nullptr};

cvar_t sk_controller_dmgball1 = {"sk_controller_dmgball1", "0", 0, 0.0f, nullptr};
cvar_t sk_controller_dmgball2 = {"sk_controller_dmgball2", "0", 0, 0.0f, nullptr};
cvar_t sk_controller_dmgball3 = {"sk_controller_dmgball3", "0", 0, 0.0f, nullptr};

// Nihilanth
cvar_t sk_nihilanth_health1 = {"sk_nihilanth_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_nihilanth_health2 = {"sk_nihilanth_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_nihilanth_health3 = {"sk_nihilanth_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_nihilanth_zap1 = {"sk_nihilanth_zap1", "0", 0, 0.0f, nullptr};
cvar_t sk_nihilanth_zap2 = {"sk_nihilanth_zap2", "0", 0, 0.0f, nullptr};
cvar_t sk_nihilanth_zap3 = {"sk_nihilanth_zap3", "0", 0, 0.0f, nullptr};

// Scientist
cvar_t sk_scientist_health1 = {"sk_scientist_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_scientist_health2 = {"sk_scientist_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_scientist_health3 = {"sk_scientist_health3", "0", 0, 0.0f, nullptr};

// Snark
cvar_t sk_snark_health1 = {"sk_snark_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_snark_health2 = {"sk_snark_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_snark_health3 = {"sk_snark_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_snark_dmg_bite1 = {"sk_snark_dmg_bite1", "0", 0, 0.0f, nullptr};
cvar_t sk_snark_dmg_bite2 = {"sk_snark_dmg_bite2", "0", 0, 0.0f, nullptr};
cvar_t sk_snark_dmg_bite3 = {"sk_snark_dmg_bite3", "0", 0, 0.0f, nullptr};

cvar_t sk_snark_dmg_pop1 = {"sk_snark_dmg_pop1", "0", 0, 0.0f, nullptr};
cvar_t sk_snark_dmg_pop2 = {"sk_snark_dmg_pop2", "0", 0, 0.0f, nullptr};
cvar_t sk_snark_dmg_pop3 = {"sk_snark_dmg_pop3", "0", 0, 0.0f, nullptr};

// Zombie
cvar_t sk_zombie_health1 = {"sk_zombie_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_zombie_health2 = {"sk_zombie_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_zombie_health3 = {"sk_zombie_health3", "0", 0, 0.0f, nullptr};

cvar_t sk_zombie_dmg_one_slash1 = {"sk_zombie_dmg_one_slash1", "0", 0, 0.0f, nullptr};
cvar_t sk_zombie_dmg_one_slash2 = {"sk_zombie_dmg_one_slash2", "0", 0, 0.0f, nullptr};
cvar_t sk_zombie_dmg_one_slash3 = {"sk_zombie_dmg_one_slash3", "0", 0, 0.0f, nullptr};

cvar_t sk_zombie_dmg_both_slash1 = {"sk_zombie_dmg_both_slash1", "0", 0, 0.0f, nullptr};
cvar_t sk_zombie_dmg_both_slash2 = {"sk_zombie_dmg_both_slash2", "0", 0, 0.0f, nullptr};
cvar_t sk_zombie_dmg_both_slash3 = {"sk_zombie_dmg_both_slash3", "0", 0, 0.0f, nullptr};

// Turret
cvar_t sk_turret_health1 = {"sk_turret_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_turret_health2 = {"sk_turret_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_turret_health3 = {"sk_turret_health3", "0", 0, 0.0f, nullptr};

// MiniTurret
cvar_t sk_miniturret_health1 = {"sk_miniturret_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_miniturret_health2 = {"sk_miniturret_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_miniturret_health3 = {"sk_miniturret_health3", "0", 0, 0.0f, nullptr};

// Sentry Turret
cvar_t sk_sentry_health1 = {"sk_sentry_health1", "0", 0, 0.0f, nullptr};
cvar_t sk_sentry_health2 = {"sk_sentry_health2", "0", 0, 0.0f, nullptr};
cvar_t sk_sentry_health3 = {"sk_sentry_health3", "0", 0, 0.0f, nullptr};

// PLAYER WEAPONS

// Crowbar whack
cvar_t sk_plr_crowbar1 = {"sk_plr_crowbar1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_crowbar2 = {"sk_plr_crowbar2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_crowbar3 = {"sk_plr_crowbar3", "0", 0, 0.0f, nullptr};
...
// Crossbow
cvar_t sk_plr_xbow_bolt_client1 = {"sk_plr_xbow_bolt_client1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_xbow_bolt_client2 = {"sk_plr_xbow_bolt_client2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_xbow_bolt_client3 = {"sk_plr_xbow_bolt_client3", "0", 0, 0.0f, nullptr};

cvar_t sk_plr_xbow_bolt_monster1 = {"sk_plr_xbow_bolt_monster1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_xbow_bolt_monster2 = {"sk_plr_xbow_bolt_monster2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_xbow_bolt_monster3 = {"sk_plr_xbow_bolt_monster3", "0", 0, 0.0f, nullptr};
...
cvar_t sk_plr_gauss1 = {"sk_plr_gauss1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_gauss2 = {"sk_plr_gauss2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_gauss3 = {"sk_plr_gauss3", "0", 0, 0.0f, nullptr};

// Tau Cannon
cvar_t sk_plr_egon_narrow1 = {"sk_plr_egon_narrow1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_egon_narrow2 = {"sk_plr_egon_narrow2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_egon_narrow3 = {"sk_plr_egon_narrow3", "0", 0, 0.0f, nullptr};

cvar_t sk_plr_egon_wide1 = {"sk_plr_egon_wide1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_egon_wide2 = {"sk_plr_egon_wide2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_egon_wide3 = {"sk_plr_egon_wide3", "0", 0, 0.0f, nullptr};

// Hand Grendade
cvar_t sk_plr_hand_grenade1 = {"sk_plr_hand_grenade1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_hand_grenade2 = {"sk_plr_hand_grenade2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_hand_grenade3 = {"sk_plr_hand_grenade3", "0", 0, 0.0f, nullptr};

// Satchel Charge
cvar_t sk_plr_satchel1 = {"sk_plr_satchel1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_satchel2 = {"sk_plr_satchel2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_satchel3 = {"sk_plr_satchel3", "0", 0, 0.0f, nullptr};

// Tripmine
cvar_t sk_plr_tripmine1 = {"sk_plr_tripmine1", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_tripmine2 = {"sk_plr_tripmine2", "0", 0, 0.0f, nullptr};
cvar_t sk_plr_tripmine3 = {"sk_plr_tripmine3", "0", 0, 0.0f, nullptr};
...
// HORNET
cvar_t sk_hornet_dmg1 = {"sk_hornet_dmg1", "0", 0, 0.0f, nullptr};
cvar_t sk_hornet_dmg2 = {"sk_hornet_dmg2", "0", 0, 0.0f, nullptr};
cvar_t sk_hornet_dmg3 = {"sk_hornet_dmg3", "0", 0, 0.0f, nullptr};
...
cvar_t sk_monster_head1 = {"sk_monster_head1", "2", 0, 2.0f, nullptr};
cvar_t sk_monster_head2 = {"sk_monster_head2", "2", 0, 2.0f, nullptr};
cvar_t sk_monster_head3 = {"sk_monster_head3", "2", 0, 2.0f, nullptr};

cvar_t sk_monster_chest1 = {"sk_monster_chest1", "1", 0, 1.0f, nullptr};
cvar_t sk_monster_chest2 = {"sk_monster_chest2", "1", 0, 1.0f, nullptr};
cvar_t sk_monster_chest3 = {"sk_monster_chest3", "1", 0, 1.0f, nullptr};

cvar_t sk_monster_stomach1 = {"sk_monster_stomach1", "1", 0, 1.0f, nullptr};
cvar_t sk_monster_stomach2 = {"sk_monster_stomach2", "1", 0, 1.0f, nullptr};
cvar_t sk_monster_stomach3 = {"sk_monster_stomach3", "1", 0, 1.0f, nullptr};

cvar_t sk_monster_arm1 = {"sk_monster_arm1", "1", 0, 1.0f, nullptr};
cvar_t sk_monster_arm2 = {"sk_monster_arm2", "1", 0, 1.0f, nullptr};
cvar_t sk_monster_arm3 = {"sk_monster_arm3", "1", 0, 1.0f, nullptr};

cvar_t sk_monster_leg1 = {"sk_monster_leg1", "1", 0, 1.0f, nullptr};
cvar_t sk_monster_leg2 = {"sk_monster_leg2", "1", 0, 1.0f, nullptr};
cvar_t sk_monster_leg3 = {"sk_monster_leg3", "1", 0, 1.0f, nullptr};

// player damage adjusters
cvar_t sk_player_head1 = {"sk_player_head1", "2", 0, 2.0f, nullptr};
cvar_t sk_player_head2 = {"sk_player_head2", "2", 0, 2.0f, nullptr};
cvar_t sk_player_head3 = {"sk_player_head3", "2", 0, 2.0f, nullptr};

cvar_t sk_player_chest1 = {"sk_player_chest1", "1", 0, 1.0f, nullptr};
cvar_t sk_player_chest2 = {"sk_player_chest2", "1", 0, 1.0f, nullptr};
cvar_t sk_player_chest3 = {"sk_player_chest3", "1", 0, 1.0f, nullptr};

cvar_t sk_player_stomach1 = {"sk_player_stomach1", "1", 0, 1.0f, nullptr};
cvar_t sk_player_stomach2 = {"sk_player_stomach2", "1", 0, 1.0f, nullptr};
cvar_t sk_player_stomach3 = {"sk_player_stomach3", "1", 0, 1.0f, nullptr};

cvar_t sk_player_arm1 = {"sk_player_arm1", "1", 0, 1.0f, nullptr};
cvar_t sk_player_arm2 = {"sk_player_arm2", "1", 0, 1.0f, nullptr};
cvar_t sk_player_arm3 = {"sk_player_arm3", "1", 0, 1.0f, nullptr};

cvar_t sk_player_leg1 = {"sk_player_leg1", "1", 0, 1.0f, nullptr};
cvar_t sk_player_leg2 = {"sk_player_leg2", "1", 0, 1.0f, nullptr};
cvar_t sk_player_leg3 = {"sk_player_leg3", "1", 0, 1.0f, nullptr};
