...
void CGlobalState::EntityAdd(string_t globalname, string_t mapName, GLOBALESTATE state)
{
	...
	m_pList = pNewEntity;
	PlatformLib_StrCpy(pNewEntity->name, sizeof(pNewEntity->name), STRING(globalname));
	PlatformLib_StrCpy(pNewEntity->levelName, sizeof(pNewEntity->levelName), STRING(mapName));
...
void CGlobalState::EntityUpdate(string_t globalname, string_t mapname)
{
	...
	if ( pEnt )
	{
		PlatformLib_StrCpy(pEnt->levelName, sizeof(pEnt->levelName), STRING(mapname));
	}
}
...
void CWorld::Precache(void)
{
	...
	CGameResources::StaticInstance().Precache(
...
// 	trace_t* /* trace */)
// {
// 	ALERT(at_console, "ClipMoveToEntity\n");
// }

// static void ClipPMoveToEntity(
// 	struct physent_s* /* pe */,
// 	const float* /* start */,
// 	float* /* mins */,
// 	float* /* maxs */,
...
// 	struct pmtrace_s* /* tr */)
// {
// 	ALERT(at_console, "ClipPMoveToEntity\n");
// }

static physics_interface_t gPhysicsInterface = {
	SV_PHYSICS_INTERFACE_VERSION,
	DispatchCreateEntity,  // SV_CreateEntity
	DispatchPhysicsEntity,  // SV_PhysicsEntity
	nullptr,  // SV_LoadEntities
	nullptr,  // SV_UpdatePlayerBaseVelocity
	nullptr,  // SV_AllowSaveGame
	nullptr,  // SV_TriggerTouch
	nullptr,  // SV_CheckFeatures
	nullptr,  // DrawDebugTriangles
	nullptr,  // DrawNormalTriangles
	nullptr,  // DrawOrthoTriangles
	nullptr,  // ClipMoveToEntity
	nullptr,  // ClipPMoveToEntity
	nullptr,  // SV_EndFrame
	nullptr,  // pfnPrepWorldFrame
	nullptr,  // pfnCreateEntitiesInRestoreList
	nullptr,  // pfnAllocString
	nullptr,  // pfnMakeString
	nullptr,  // pfnGetString
	nullptr,  // pfnRestoreDecal
	nullptr,  // PM_PlayerTouch
	nullptr,  // Mod_ProcessUserData
	nullptr,  // SV_HullForBsp
	nullptr,  // SV_PlayerThink
};
