...
namespace good
{
	...
	//--------------------------------------------------------------------------------------------------------
	/// Split string into several strings by separator, optionally trimming resulting strings. Put result in given
	/// array.
	//--------------------------------------------------------------------------------------------------------
	template<template<typename, typename> class Container, typename String, template<typename> class Alloc>
	void
	split(const String& sStr, Container<String, Alloc<String>>& aContainer, char separator = ' ', bool bTrim = false)
	{
