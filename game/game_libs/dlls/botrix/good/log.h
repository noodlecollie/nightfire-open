...
namespace good
{
	...
	public:
		 ...
		 */
		static size_t format(char* szOutput, size_t iOutputSize, const char* szFmt, ...) FORMAT_FUNCTION(3, 4);
		 ...
		 * @param szFmt format string.
		 */
		static size_t printf(TLogLevel iLevel, const char* szFmt, ...) FORMAT_FUNCTION(2, 3);
