...
namespace good
{
	...
	public:
		...
		public:
			...
			/// Operator ==.
			bool operator==(const_iterator const& itOther) const
			{
		...
		public:
			...
			iterator(const_iterator const& itOther) :
				base_class(itOther)
			{
			}
			// Copy constructor.
			...
			{
				base_class::m_pCurrent = other.m_pCurrent;
				return *this;
			}
			...
			iterator& operator++()
			{
				...
				this->m_pCurrent = this->m_pCurrent->next;
				return *this;
			}
			/// Pre-decrement.
			iterator& operator--()
			{
				GoodAssert(this->m_pCurrent);
				this->m_pCurrent = this->m_pCurrent->prev;
				return *this;
			}
		...
		{
			return const_iterator(m_pTail->next);
		}
		...
		{
			return const_iterator(m_pTail->prev);
		}
