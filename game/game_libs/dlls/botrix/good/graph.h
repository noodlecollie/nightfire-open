...
namespace good
{
	...
	public:
		...
		public:
			...
			/// Node constructor.
			node_t(Vertex const& v, int iNeighboursSize = 0) :
				vertex(v),
				neighbours()
			{
				if ( iNeighboursSize )
	...
	public:
		...
		/// Array subscript.
		//--------------------------------------------------------------------------------------------------------
		node_t& operator[](node_id iNodeId)
		{
			return m_cNodes[iNodeId];
		}

		//--------------------------------------------------------------------------------------------------------
		/// Array subscript const.
		//--------------------------------------------------------------------------------------------------------
		node_t const& operator[](node_id iNodeId) const
		{
			return m_cNodes[iNodeId];
		}
		...
		/// Element at index.
		//--------------------------------------------------------------------------------------------------------
		node_t const& at(node_id iNodeId) const
		{
			return m_cNodes[iNodeId];
		}
		...
		//--------------------------------------------------------------------------------------------------------
		bool is_valid(node_id iNodeId)
		{
			return (0 <= iNodeId) && (iNodeId < (int)m_cNodes.size());
		}
