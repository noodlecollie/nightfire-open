...
namespace good
{
    ...
    public:
        ...
        public:
            ...
            /// Operator -.
            int operator- ( const const_iterator& itOther ) const { GoodAssert(m_pCurrent); return static_cast<int>(m_pCurrent - itOther.m_pCurrent); }
        ...
        public:
            ...
            /// Operator -.
            int operator- ( const iterator& other ) const { GoodAssert(this->m_pCurrent); return static_cast<int>(this->m_pCurrent - other.m_pCurrent); }
