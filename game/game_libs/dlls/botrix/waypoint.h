...
public:  // Members and constants.
	...
	/// shell or object) instead of hit world. By enabling all trace, we make sure that we won't be adding waypoints at
	/// invalid positions.
...
public:  // Methods.
	...
	/// Get ammo from waypoint argument. If the ammo is for secondary weapon function (right click), then bIsSecondary
	/// is set.
...
protected:
	...
	static good::vector<CNeighbour>
		m_aWaypointsNeighbours;  // To know if waypoint made check for neighbours near, initialized during first step.
