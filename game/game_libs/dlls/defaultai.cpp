...
Schedule_t slIdleTrigger[] = {
	{tlIdleStand1, ARRAYSIZE(tlIdleStand1), bits_COND_LIGHT_DAMAGE | bits_COND_HEAVY_DAMAGE, 0, "Idle Trigger"},
};
...
Schedule_t slWakeAngry[] = {{tlWakeAngry1, ARRAYSIZE(tlWakeAngry1), 0, 0, "Wake Angry"}};
...
Schedule_t slAlertSmallFlinch[] = {
	{tlAlertSmallFlinch, ARRAYSIZE(tlAlertSmallFlinch), 0, 0, "Alert Small Flinch"},
};
...
Schedule_t slArmWeapon[] = {{tlArmWeapon, ARRAYSIZE(tlArmWeapon), 0, 0, "Arm Weapon"}};
...
Schedule_t slReload[] = {{tlReload, ARRAYSIZE(tlReload), bits_COND_HEAVY_DAMAGE, 0, "Reload"}};
...
Schedule_t slSmallFlinch[] = {
	{tlSmallFlinch, ARRAYSIZE(tlSmallFlinch), 0, 0, "Small Flinch"},
};
...
Schedule_t slDie[] = {
	{tlDie1, ARRAYSIZE(tlDie1), 0, 0, "Die"},
};
...
Schedule_t slVictoryDance[] = {
	{tlVictoryDance, ARRAYSIZE(tlVictoryDance), 0, 0, "Victory Dance"},
};
...
Schedule_t slBarnacleVictimGrab[] = {{tlBarnacleVictimGrab, ARRAYSIZE(tlBarnacleVictimGrab), 0, 0, "Barnacle Victim"}};
...
Schedule_t slBarnacleVictimChomp[] = {
	{tlBarnacleVictimChomp, ARRAYSIZE(tlBarnacleVictimChomp), 0, 0, "Barnacle Chomp"}};
...
Schedule_t slError[] = {
	{tlError, ARRAYSIZE(tlError), 0, 0, "Error"},
};
...
Schedule_t slWalkToScript[] = {
	{tlScriptedWalk, ARRAYSIZE(tlScriptedWalk), SCRIPT_BREAK_CONDITIONS, 0, "WalkToScript"},
};
...
Schedule_t slRunToScript[] = {
	{tlScriptedRun, ARRAYSIZE(tlScriptedRun), SCRIPT_BREAK_CONDITIONS, 0, "RunToScript"},
};
...
Schedule_t slWaitScript[] = {
	{tlScriptedWait, ARRAYSIZE(tlScriptedWait), SCRIPT_BREAK_CONDITIONS, 0, "WaitForScript"},
};
...
Schedule_t slFaceScript[] = {
	{tlScriptedFace, ARRAYSIZE(tlScriptedFace), SCRIPT_BREAK_CONDITIONS, 0, "FaceScript"},
};
...
Schedule_t slCower[] = {
	{tlCower, ARRAYSIZE(tlCower), 0, 0, "Cower"},
};
...
Schedule_t slTakeCoverFromOrigin[] = {
	{tlTakeCoverFromOrigin, ARRAYSIZE(tlTakeCoverFromOrigin), bits_COND_NEW_ENEMY, 0, "TakeCoverFromOrigin"},
};
...
Schedule_t slTakeCoverFromBestSound[] = {
	{tlTakeCoverFromBestSound, ARRAYSIZE(tlTakeCoverFromBestSound), bits_COND_NEW_ENEMY, 0, "TakeCoverFromBestSound"},
};
...
Schedule_t slTakeCoverFromEnemy[] = {
	{tlTakeCoverFromEnemy, ARRAYSIZE(tlTakeCoverFromEnemy), bits_COND_NEW_ENEMY, 0, "tlTakeCoverFromEnemy"},
};
