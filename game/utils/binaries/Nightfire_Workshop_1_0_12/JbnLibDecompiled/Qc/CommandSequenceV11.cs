...
// Type: JbnLib.Qc.CommandSequenceV11
...
namespace JbnLib.Qc
{
  public class CommandSequenceV11
  {
    ...
    public CommandSequenceV10 ToV10()
    {
      ...
      if (this._Activity != null)
        v10.Activity = new OptionActivityV10((ActivityV10) Enumerators.ConvertActivity(typeof (ActivityV11), typeof (ActivityV10), (object) this._Activity.Activity), this._Activity.ActivityWeight);
    ...
    public CommandSequenceV44 ToV44()
    {
      ...
      if (this._Activity != null)
        v44.Activity = new OptionActivityV44((ActivityV44) Enumerators.ConvertActivity(typeof (ActivityV11), typeof (ActivityV44), (object) this._Activity.Activity), this._Activity.ActivityWeight);
