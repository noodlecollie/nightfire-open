...
// Type: JbnLib.Fgd.Types.ClassIconSprite
...
namespace JbnLib.Fgd.Types
{
  public class ClassIconSprite
  {
    ...
    public ClassIconSprite()
    {
    }

    public ClassIconSprite(string sprite, string extra)
    {
      this._Sprite = sprite;
      this._Extra = extra;
    }

    public ClassIconSprite(string data)
    {
