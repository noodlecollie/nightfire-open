...
static FORCEINLINE int ffsl(uint32_t mask)
{
	if ( mask == 0 )
	{
		return 0;
...
*/
static winding_t*
ClipToSeperators(winding_t* source, winding_t* pass, winding_t* target, bool flipclip, pstack_t* stack)
{
	int i, j, k, l;
	int counts[3];
	bool fliptest;
