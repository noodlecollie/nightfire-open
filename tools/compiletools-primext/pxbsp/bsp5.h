...
#define BSPCHOP_EPSILON (Q_min(g_prtepsilon * 4.0f, ON_EPSILON))
...
#define FNODE_LEAFPORTAL \
	(1 << 1)  // not detail and children are detail; only visleafs have contents, portals, mins, maxs
