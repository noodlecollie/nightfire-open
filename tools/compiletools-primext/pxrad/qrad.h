...
#define RAD_MAX_PATH 1024

#define DEFAULT_FASTMODE false
#define DEFAULT_EXTRAMODE false
#define DEFAULT_TEXSCALE true
#define DEFAULT_CHOP 128.0f
#define DEFAULT_TEXCHOP 32.0f
#define DEFAULT_DLIGHT_SCALE 2.0f
#define DEFAULT_LIGHT_SCALE 1.0f
#define DEFAULT_LERP_ENABLED false
#define DEFAULT_WADTEXTURES false
#define DEFAULT_DIRTMAPPING false
#define DEFAULT_TEXREFLECTGAMMA (1.0f / 2.2f)  // turn back to linear space
#define DEFAULT_TEXREFLECTSCALE 1.0f
#define DEFAULT_BLUR 1.0f
#define DEFAULT_BOUNCE 3
#define DEFAULT_LIGHTCLIP 196
#define DEFAULT_SMOOTHVALUE 50.0f
#define DEFAULT_INDIRECT_SUN 1.0f
#define DEFAULT_GAMMA 0.5f
#define DEFAULT_COMPAT_MODE CompatibilityMode::PrimeXT
#define DLIGHT_THRESHOLD 10.0f
...
typedef struct patch_s
{
	...
	vec3_t
		totallight[MAXLIGHTMAPS];  // accumulated by radiosity does NOT include light accounted for by direct lighting
...
extern char source[RAD_MAX_PATH];
