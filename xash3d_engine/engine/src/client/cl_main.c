...
void CL_InternetServers_f(void)
{
	...
	if ( NET_MasterServersDisabled() )
	{
		Con_Printf("Master servers are disabled in this build. Not scanning for servers\n");
		return;
	}
...
void CL_InitLocal(void)
{
	...
	cl_idealpitchscale =
		Cvar_Get("cl_idealpitchscale", "0.8", 0, "how much to look up/down slopes and stairs when not using freelook");
	...
	cl_lightstyle_lerping =
		Cvar_Get("cl_lightstyle_lerping", "0", FCVAR_ARCHIVE, "enables animated light lerping (perfomance option)");
