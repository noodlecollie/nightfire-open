...
wavdata_t* S_LoadSound(sfx_t* sfx)
{
	...
	{
		Con_Printf(
			S_WARN "Sound %s has invalid sample rate of %.2fKHz, resampling to 11KHz.\n",
			sfx->name,
			sc->rate / 1000.0f);
	...
	{
		Con_Printf(
			S_WARN "Sound %s has invalid sample rate of %.2fKHz, resampling to 22KHz.\n",
			sfx->name,
			sc->rate / 1000.0f);
	...
	{
		Con_Printf(
			S_WARN "Sound %s has invalid sample rate of %.2fKHz, resampling to 44KHz.\n",
			sfx->name,
			sc->rate / 1000.0f);
