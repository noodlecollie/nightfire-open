...
void SV_Init(void)
{
	...
	sv_validate_changelevel =
		Cvar_Get("sv_validate_changelevel", "0", 0, "test change level for level-designer errors");
	...
	sv_allow_noinputdevices =
		Cvar_Get("sv_allow_noinputdevices", "1", FCVAR_ARCHIVE, "allow connect from old versions without useragent");
