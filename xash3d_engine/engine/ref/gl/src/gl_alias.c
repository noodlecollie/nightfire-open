...
void GL_MakeAliasModelDisplayLists(model_t* m)
{
	...
	m_pAliasHeader->posedata =
		Mem_Malloc(m->mempool, m_pAliasHeader->numposes * m_pAliasHeader->poseverts * sizeof(trivertex_t));
