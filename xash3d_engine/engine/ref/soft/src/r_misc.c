...
#define PLANE_ANYZ 5
	...
	xcenter = ((float)RI.vrect.width * XCENTERING) + RI.vrect.x - 0.5f;
	aliasxcenter = xcenter * r_aliasuvscale;
	ycenter = ((float)RI.vrect.height * YCENTERING) + RI.vrect.y - 0.5f;
	...
	// right side clip
	qfrustum.screenedge[1].normal[0] = 1.0f / ((1.0f - xOrigin) * horizontalFieldOfView);
