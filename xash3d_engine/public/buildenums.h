...
#define PLATFORM_DOS4GW 7
#define PLATFORM_HAIKU 8
#define PLATFORM_SERENITY 9
#define PLATFORM_IRIX 10
#define PLATFORM_NSWITCH 11
#define PLATFORM_PSVITA 12
#define PLATFORM_LINUX_UNKNOWN 13
