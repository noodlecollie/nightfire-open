...
#define PLATFORM_NETBSD 5
#define PLATFORM_OPENBSD 6
#define PLATFORM_EMSCRIPTEN 7
#define PLATFORM_DOS4GW 8
#define PLATFORM_HAIKU 9
#define PLATFORM_SERENITY 10
#define PLATFORM_IRIX 11
#define PLATFORM_NSWITCH 12
#define PLATFORM_PSVITA 13
