...
#define FL_KILLME \
	(1U << 30)  // This entity is marked for death -- This allows the engine to kill ents at the appropriate time
...
// entity effects
#define EF_BRIGHTFIELD (1U << 0)  // swirling cloud of particles
#define EF_MUZZLEFLASH (1U << 1)  // single frame ELIGHT on entity attachment 0
#define EF_BRIGHTLIGHT (1U << 2)  // DLIGHT centered at entity origin
#define EF_DIMLIGHT (1U << 3)  // player flashlight
#define EF_INVLIGHT (1U << 4)  // get lighting from ceiling
#define EF_NOINTERP (1U << 5)  // don't interpolate the next frame
#define EF_LIGHT (1U << 6)  // rocket flare glow sprite
#define EF_NODRAW (1U << 7)  // don't draw entity
...
#define TE_EXPLOSION \
	3  // additive sprite, 2 dynamic lights, flickering particles, explosion sound, move vertically 8 pps
// coord coord coord (position)
// short (sprite index)
// byte (scale in 0.1's)
// byte (framerate)
...
#define TE_EXPLFLAG_NOADDITIVE \
	1  // sprite will be drawn opaque (ensure that the sprite you send is a non-additive sprite)
...
#define TE_BLOODSPRITE \
	115  // spray of opaque sprite1's that fall, single sprite2 for 1..2 secs (this is a high-priority tent)
// coord, coord, coord (position)
// short (sprite1 index)
// short (sprite2 index)
// byte (color)
