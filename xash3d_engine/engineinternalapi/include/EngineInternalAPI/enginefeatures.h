...
#define ENGINE_WRITE_LARGE_COORD \
	(1 << 0)  // replace standard message WRITE_COORD with big message for support more than 8192 units in world
...
#define ENGINE_COMPENSATE_QUAKE_BUG \
	(1 << 5)  // compensate stupid quake bug (inverse pitch) for mods where this bug is fixed
