...
public:
	...
	virtual void CreateDirHierarchy(
		const char*,
		const char*) = 0; /* linkage=_ZN11IFileSystem18CreateDirHierarchyEPKcS1_ */
	...
	virtual void
	Seek(FileHandle_t, int, FileSystemSeek_t) = 0; /* linkage=_ZN11IFileSystem4SeekEPvi16FileSystemSeek_t */
	...
	virtual const char*
	FindFirst(const char*, FileFindHandle_t*, const char*) = 0; /* linkage=_ZN11IFileSystem9FindFirstEPKcPiS1_ */
	...
	virtual void SetWarningLevel(
		FileWarningLevel_t) = 0; /* linkage=_ZN11IFileSystem15SetWarningLevelE18FileWarningLevel_t */
	...
	virtual bool IsFileImmediatelyAvailable(
		const char*) = 0; /* linkage=_ZN11IFileSystem26IsFileImmediatelyAvailableEPKc */

	virtual WaitForResourcesHandle_t WaitForResources(
		const char*) = 0; /* linkage=_ZN11IFileSystem16WaitForResourcesEPKc */

	virtual bool GetWaitForResourcesProgress(
		WaitForResourcesHandle_t,
		float*,
		bool*) = 0; /* linkage=_ZN11IFileSystem27GetWaitForResourcesProgressEiPfPb */

	virtual void CancelWaitForResources(
		WaitForResourcesHandle_t) = 0; /* linkage=_ZN11IFileSystem22CancelWaitForResourcesEi */
	...
	virtual FileHandle_t OpenFromCacheForRead(
		const char*,
		const char*,
		const char*) = 0; /* linkage=_ZN11IFileSystem20OpenFromCacheForReadEPKcS1_S1_ */

	virtual void AddSearchPathNoWrite(
		const char*,
		const char*) = 0; /* linkage=_ZN11IFileSystem20AddSearchPathNoWriteEPKcS1_ */
};
