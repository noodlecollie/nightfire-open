...
#include "EngineGamesAPI/studio_event.h"
...
#define STUDIO_BLENDPOSE \
	0x0040  // to differentiate GoldSrc style blending from Source style blending (with pose parameters)
